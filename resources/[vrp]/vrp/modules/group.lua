...
function vRP.removeUserGroup(user_id,group)
	...
	if not groupdef then
		print('^1[ - ] waze GROUPS >^7 Foi constatado um erro, o grupo digitado não existe.')
		return 
	end
	...
	local source = vRP.getUserSource(user_id)
	if source == nil then
		TriggerEvent("waze:forceDbUpdate",user_id,group)
	end
end
...
--}
--
--function vRP.SetadosPolicia(grupo)
--	return SetPoliciais[grupo]
--end
--
--function vRP.AddSetPolicia(grupo, user_id)
--	SetPoliciais[grupo][user_id] = true
--end
--
--function vRP.DelSetPolicia(user_id)
--
--	if SetPoliciais['norte'][user_id] then
--		SetPoliciais['norte'][user_id] = nil
--	end
--
--	if SetPoliciais['sul'][user_id] then
--		SetPoliciais['sul'][user_id] = nil
--	end
--
--	if SetPoliciais['aluno'][user_id] then
--		SetPoliciais['aluno'][user_id] = nil
--	end
--
--end
--
