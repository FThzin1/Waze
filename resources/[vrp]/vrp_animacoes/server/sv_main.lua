...
RegisterCommand('e',function(source,args,rawCommand)
	...
	if nplayer and not vRPclient.isInVehicle(nplayer) and not vRPclient.isHandcuffed(nplayer) and vRPclient.getHealth(nplayer) > 101 then
		...
		--	if vRP.request(nplayer,"Deseja casal2 com <b>"..identity.name.." "..identity.firstname.."</b> ?",5) then
		--		TriggerClientEvent("syncAnim",source,0.3)
		...
		--	if vRP.request(nplayer,"Deseja casal3 com <b>"..identity.name.." "..identity.firstname.."</b> ?",5) then
		--		TriggerClientEvent("syncAnim",source,0.3)
...
AddEventHandler("trySyncParticle",function(asset,v)
    TriggerClientEvent("wazeSyncParticle",-1,asset,v)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- STOP SYNC PARTICLE
-----------------------------------------------------------------------------------------------------------------------------------------
