...
-----------------------------------------------------------------------------------------------------------------------------------------
local coordsSystem = {
	{ coords = vec3(1322.93,-1652.29,52.27) },
	{ coords = vec3(-1154.42,-1425.9,4.95) },
	{ coords = vec3(322.84,180.16,103.58) },
	{ coords = vec3(-3169.62,1075.8,20.83) },
	{ coords = vec3(1864.07,3747.9,33.03) },
	{ coords = vec3(-293.57,6199.85,31.48) }
}
...
CreateThread(function()
    while true do
        ...
        if not IsPedInAnyVehicle(ped) then
            ...
            for i=1, #coordsSystem do
                local coords = coordsSystem[i].coords
                local distance = #(coordsPed - coords)
                if distance <= 10 then
                    timeDistance = 4
                    DrawMarker(23,coords.x,coords.y,coords.z-0.95,0,0,0,0,0,0,1.5,1.5,1.5,42,137,255,100,0,0,0,0)
