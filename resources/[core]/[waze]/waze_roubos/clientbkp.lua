...
local Config = {
    ...
    ['Teatro'] = { -- Nome do estabelecimento
        ...
        ['Cooldown'] = 1000,  -- Cooldown pra realizar o roubo com O MESMO TIPO DE COOLDOWN
        ['ItemReq'] = 'notebook', -- Item necessário pra iniciar o roubo, nil = não precisa de item
    ...
    ['Fazenda'] = { -- Nome do estabelecimento Fazenda
        ...
        ['Cooldown'] = 950,  -- Cooldown pra realizar o roubo com O MESMO TIPO DE COOLDOWN
        ['ItemReq'] = 'notebook', -- Item necessário pra iniciar o roubo, nil = não precisa de item
        ['MinPoliciais'] = 12,  -- Mínimo de policiais em serviço pra iniciar o roubo
        ['MaxPoliciais'] = 16,
        ['PermDosPm'] = 'policia.permissao', -- O que o sistema considerará policial
    ...
    ['Moto club do Sul'] = { -- Nome do estabelecimento Moto club do Sul
        ...
        ['Cooldown'] = 800,  -- Cooldown pra realizar o roubo com O MESMO TIPO DE COOLDOWN
        ['ItemReq'] = 'notebook', -- Item necessário pra iniciar o roubo, nil = não precisa de item
        ['MinPoliciais'] = 5,  -- Mínimo de policiais em serviço pra iniciar o roubo
        ['MaxPoliciais'] = 6,
        ['PermDosPm'] = 'policia.permissao', -- O que o sistema considerará policial
    ...
    ['Reserva Nacional de Niobio'] = { -- Nome do estabelecimento Reserva Nacional de Niobio
        ...
        ['ItemReq'] = 'notebook', -- Item necessário pra iniciar o roubo, nil = não precisa de item
        ['MinPoliciais'] = 19,  -- Mínimo de policiais em serviço pra iniciar o roubo
        ['MaxPoliciais'] = 24,
        ['PermDosPm'] = 'policia.permissao', -- O que o sistema considerará policial
        ['Prioridade'] = 'sul'
    },
    ['Vanilla'] = { -- Nome do estabelecimento Vanilla
        ...
        ['TempoRoubo'] = 160,  -- Tempo que demorará pra terminar o roubo
        ['Recompensa'] = math.random(98000,190000),  -- Recompensa de dinheiro sujo no roubo
        ['TipoCooldown'] = 'Vanilla', -- Cooldown, use a mesma palavra para ter o MESMO COOLDOWN
        ['Cooldown'] = 600,  -- Cooldown pra realizar o roubo com O MESMO TIPO DE COOLDOWN
        ['ItemReq'] = 'notebook', -- Item necessário pra iniciar o roubo, nil = não precisa de item
        ['MinPoliciais'] = 9,  -- Mínimo de policiais em serviço pra iniciar o roubo
        ['MaxPoliciais'] = 10,
        ['PermDosPm'] = 'policia.permissao', -- O que o sistema considerará policial
    ...
    ['Yellow Jack Bar'] = { -- Nome do estabelecimento Yellow Jack Bar
        ...
        ['Cooldown'] = 4000,  -- Cooldown pra realizar o roubo com O MESMO TIPO DE COOLDOWN
        ['ItemReq'] = 'notebook', -- Item necessário pra iniciar o roubo, nil = não precisa de item
        ['MinPoliciais'] = 8,  -- Mínimo de policiais em serviço pra iniciar o roubo
        ['MaxPoliciais'] = 9,
        ['PermDosPm'] = 'policia.permissao', -- O que o sistema considerará policial
    ...
    ['Rebel'] = { -- Nome do estabelecimento Rebel
    ...
    ['Stay Frost'] = { -- Nome do estabelecimento Stay Frost
        ['x'] = 960.86, ['y'] = -1585.98, ['z'] = 30.37, ['h'] = 135.6, -- Posição
    ...
    ['Estabulo'] = { -- Nome do estabelecimento Estabulo
        ...
        ['TempoRoubo'] = 208, -- Tempo que demorará pra terminar o roubo 
    ...
    ['Posto'] = { -- Nome do estabelecimento Posto
    	...
    	['TempoRoubo'] = 173, -- Tempo que demorará pra terminar o roubo 
    ...
    ['Departamento Abandonado'] = { -- Nome do estabelecimento Departamento Abandonado
        ...
        ['Recompensa'] = math.random(180000,280000), -- Recompensa de dinheiro sujo no roubo
    ...
    ['Auditorio'] = { -- Nome do estabelecimento Auditorio
        ...
        ['TempoRoubo'] = 171, -- Tempo que demorará pra terminar o roubo 
        ['Recompensa'] = math.random(180000,320000), -- Recompensa de dinheiro sujo no roubo
    ...
    ['Caixa da Água'] = { -- Nome do estabelecimento Caixa da Agua
        ...
        ['TempoRoubo'] = 202, -- Tempo que demorará pra terminar o roubo 
        ['Recompensa'] = math.random(140000,270000), -- Recompensa de dinheiro sujo no roubo
    ...
    ['Shipping Services'] = { -- Nome do estabelecimento Shipping Services
        ...
        ['Recompensa'] = math.random(180000,250000), -- Recompensa de dinheiro sujo no roubo
        ['TipoCooldown'] = 'ShippingServices', -- Cooldown, use a mesma palavra para ter o MESMO COOLDOWN 
        ['Cooldown'] = 720,  -- Cooldown pra realizar o roubo com O MESMO TIPO DE COOLDOWN
        ['ItemReq'] = 'notebook',  -- Item necessário pra iniciar o roubo, nil = não precisa de item 
        ['MinPoliciais'] = 5,  -- Mínimo de policiais em serviço pra iniciar o roubo
        ['MaxPoliciais'] = 6, 
        ['PermDosPm'] = 'policia.permissao', -- O que o sistema considerará policial 
    ...
    ['Hay Day'] = { -- Nome do estabelecimento Roubo ao Hay Day
        ...
        ['TempoRoubo'] = 170, -- Tempo que demorará pra terminar o roubo 
        ['Recompensa'] = math.random(130000,270000), -- Recompensa de dinheiro sujo no roubo  
    ...
    ['Parking Bilgeco'] = { -- Nome do estabelecimento Parking Bilgeco
        ...
        ['Recompensa'] = math.random(240000,277597), -- Recompensa de dinheiro sujo no roubo
    ...
    ['Trailer Magic'] = { -- Nome do estabelecimento Trailer Magic
        ...
        ['TempoRoubo'] = 209, -- Tempo que demorará pra terminar o roubo 
    ...
    ['Palacio'] = { -- Nome do estabelecimento Palacio
        ['x'] = -429.73, ['y'] = 1109.67, ['z'] = 327.69, ['h'] = 180.35, -- Posição  
        ['TempoRoubo'] = 183, -- Tempo que demorará pra terminar o roubo 
        ['Recompensa'] = math.random(190000,290000), -- Recompensa de dinheiro sujo no roubo  
    ...
    ['Delegacia da Praca'] = { -- Nome do estabelecimento Delegacia Da Praca
        ...
        ['TempoRoubo'] = 174, -- Tempo que demorará pra terminar o roubo 
        ['Recompensa'] = math.random(220000,340000), -- Recompensa de dinheiro sujo no roubo  
    ...
    ['Estadio'] = { -- Nome do estabelecimento Estadio
        ...
        ['TempoRoubo'] = 221, -- Tempo que demorará pra terminar o roubo 
        ['Recompensa'] = math.random(220000,340000), -- Recompensa de dinheiro sujo no roubo  
    ...
    ['Mini Porto'] = { -- Nome do estabelecimento Mini Porto
        ...
        ['Recompensa'] = math.random(260000,330000), -- Recompensa de dinheiro sujo no roubo  
        ['TipoCooldown'] = 'MiniPorto', -- Cooldown, use a mesma palavra para ter o MESMO COOLDOWN 
        ['Cooldown'] = 830,  -- Cooldown pra realizar o roubo com O MESMO TIPO DE COOLDOWN  
        ['ItemReq'] = 'notebook',  -- Item necessário pra iniciar o roubo, nil = não precisa de item 
        ['MinPoliciais'] = 8,  -- Mínimo de policiais em serviço pra iniciar o roubo  
        ['MaxPoliciais'] = 14, 
        ['PermDosPm'] = 'policia.permissao', -- O que o sistema considerará policial 
    ...
    ['Cypress'] = { -- Nome do estabelecimento Cypress
        ...
        ['TempoRoubo'] = 204, -- Tempo que demorará pra terminar o roubo 
    ...
    ['Fabrica'] = { -- Nome do estabelecimento Fabrica
         ['x'] = 287.77, ['y'] = 2843.78, ['z'] = 44.71, ['h'] = 304.25, -- Posição  
        ['TempoRoubo'] = 153, -- Tempo que demorará pra terminar o roubo 
        ['Recompensa'] = math.random(180000,230000), -- Recompensa de dinheiro sujo no roubo  
    ...
    ['Faculdade'] = { -- Nome do estabelecimento Faculdade
        ['x'] = -2299.71, ['y'] = 336.85, ['z'] = 174.61, -- Posição  
        ['TempoRoubo'] = 153, -- Tempo que demorará pra terminar o roubo 
        ['Recompensa'] = math.random(180000,290000), -- Recompensa de dinheiro sujo no roubo  
        ['TipoCooldown'] = 'Faculdade', -- Cooldown, use a mesma palavra para ter o MESMO COOLDOWN 
        ['Cooldown'] = 700,  -- Cooldown pra realizar o roubo com O MESMO TIPO DE COOLDOWN  
        ['ItemReq'] = 'notebook',  -- Item necessário pra iniciar o roubo, nil = não precisa de item 
        ['MinPoliciais'] = 8,  -- Mínimo de policiais em serviço pra iniciar o roubo  
        ['MaxPoliciais'] = 14, 
    ...
    ['Motel Abandonado'] = { -- Nome do estabelecimento Motel Abandonado
       ['x'] = 1508.36, ['y'] = 3560.86, ['z'] = 35.32, -- Posição  
        ['TempoRoubo'] = 153, -- Tempo que demorará pra terminar o roubo 
   ...
   ['Clube de Tenis'] = { -- Nome do estabelecimento Clube de Tenis
      ['x'] = 443.75, ['y'] = -222.07, ['z'] = 56.02, -- Posição  
        ['TempoRoubo'] = 100, -- Tempo que demorará pra terminar o roubo 
        ['Recompensa'] = math.random(200000,290000), -- Recompensa de dinheiro sujo no roubo  
    ...
    while true do
        ...
        if not Roubando then
            ...
            if Roubando and TempoRoubando <= 0 then
                ...
                ClearPedTasks(ped)
                TriggerEvent('Notify', 'aviso', 'O <b>assalto</b> foi <b>concluído</b>.')
            end
        ...
        if TempoRoubando > 0 then
            ...
            if IsControlJustPressed(0,168) or not IsEntityPlayingAnim(ped,"anim@heists@ornate_bank@grab_cash", "grab",3) then
                ...
                FreezeEntityPosition(ped, false)
                ClearPedTasks(ped)
                TriggerEvent('Notify', 'aviso', 'O <b>assalto</b> foi <b>cancelado</b>.')
            end
