RegisterNetEvent("waze-personagem:wazeIntro")
RegisterNetEvent("waze-personagem:normalSpawn")
RegisterNetEvent("waze-personagem:characterCreate")
...
function drawscaleform(scaleform)
	...
	PushScaleformMovieFunctionParameterString("~r~")
	PushScaleformMovieFunctionParameterBool(true)
	PushScaleformMovieFunctionParameterString("~y~discord.gg/N7PBg9sk9e")
	PopScaleformMovieFunctionVoid()
	
	DrawScaleformMovieFullscreen(scaleform, 255, 255, 255, 255, 0)
end

-- waze TOP CAM & NORMAL SPAWN --
CreateThread(function()
	-- waze
...
-- EVENTS --
AddEventHandler("waze-personagem:wazeIntro", function()
	print("waze-personagem:wazeIntro")
	doStatus = -1
	SetTimeout(1000, function()
		TriggerServerEvent("waze-personagem:finishedIntro")
	end)
end)



AddEventHandler("waze-personagem:characterCreate", function()
	print("waze-personagem:characterCreate")
	doStatus = 1
...
AddEventHandler("waze-personagem:normalSpawn",function(firstspawn)
	if firstspawn then
		...
		TriggerCamController(-1)
		TriggerEvent("rusher_login:wazeShowing")
	end
end)
...
function changeGender(model)
	...
	if HasModelLoaded(mhash) then
		...
		SetPedMaxHealth(PlayerPedId(),399)
...
RegisterNUICallback('cDoneSave', function(data, cb)
	...
	TriggerServerEvent("waze-personagem:finishedCharacter", characterNome, characterSobrenome, characterAge, currentCharacterMode)
end)
